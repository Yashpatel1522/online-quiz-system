...
<script src="js/jssor.slider-28.0.0.min.js" type="text/javascript"></script>
    ...
    <svg viewbox="0 0 0 0" width="0" height="0" style="display:block;position:relative;left:0px;top:0px;">
        <defs>
            <mask id="jssor_1_msk_1">
                <image data-load="href" width="980" height="490" x="0" y="0" style="position:absolute;max-width:980px;" href="img/css.jpg"></image>
            </mask>
            <mask id="jssor_1_msk_2">
                <image data-load="href" width="980" height="490" x="0" y="0" style="position:absolute;opacity:1;max-width:980px;" href="img/html.jpg"></image>
            </mask>
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:30px;left:0px;width:980px;height:490px;overflow:hidden;visibility:hidden;">
        <!-- Loading Screen -->
        <div data-u="loading" class="jssorl-004-double-tail-spin" style="position:absolute;top:0px;left:0px;width:100%;height:100%;text-align:center;background-color:rgba(0,0,0,0.7);">
            <img style="margin-top:-19px;position:relative;top:50%;width:38px;height:38px;" src="img/css.jpg" />
        </div>
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:490px;overflow:hidden;">
            <div data-p="735">
                ...
                <img data-t="0" style="left:0px;top:0px;width:980px;height:490px;position:absolute;opacity:0;max-width:980px;" src="img/html.jpg" />
                <svg viewbox="0 0 980 490" data-ts="preserve-3d" width="980" height="490" data-tchd="jssor_1_msk_1" style="left:0px;top:0px;display:block;position:absolute;overflow:hidden;">
                    <g mask="url(#jssor_1_msk_1)">
                        <text data-to="614px 157px" stroke="#cca48f" stroke-width="1.6" text-anchor="middle" x="614" y="182" data-t="1" style="position:absolute;font-size:48px;overflow:visible;">html
                        </text>
                    </g>
                </svg>
                ...
                <div data-ts="flat" data-p="221" data-po="55% 60%" data-t="6" style="left:0px;top:0px;width:980px;height:490px;position:absolute;opacity:0;">
                    <div data-to="50% 50%" data-ts="preserve-3d" data-t="7" style="left:519px;top:334px;width:320px;height:160px;position:absolute;">
                        <div data-to="50% 50%" data-t="8" style="left:0px;top:44px;width:320px;height:40px;position:absolute;color:#8585a6;font-size:32px;line-height:1.2;text-align:center;">&lt;br&gt;</div>
                        <div data-to="50% 50%" data-t="9" style="left:0px;top:82px;width:320px;height:40px;position:absolute;color:#8585a6;font-size:32px;line-height:1.2;text-align:center;">WE SHOULD BREAK</div>
                    </div>
                </div>
            </div>
            <div data-p="735">
                ...
                <svg viewbox="0 0 980 490" data-ts="preserve-3d" width="980" height="490" data-tchd="jssor_1_msk_2" style="left:0px;top:0px;display:block;position:absolute;overflow:visible;">
                    <g mask="url(#jssor_1_msk_2)">
                        <text data-to="530px 135px" fill="#black" x="430" y="160" data-t="14" style="position:absolute;opacity:0;font-size:40px;letter-spacing:0.02em;overflow:visible;">css
                        </text>
                        <text fill="black" x="430" y="270" data-t="15" style="position:absolute;opacity:0;font-size:40px;letter-spacing:1em;overflow:visible;">3
                        </text>
                    </g>
                </svg>
            </div>
            <div>
                ...
                <div data-ts="flat" data-p="184" data-po="50% 80%" style="left:0px;top:0px;width:980px;height:490px;position:absolute;">
                    <svg viewbox="0 0 360 210" data-to="50% 50%" width="360" height="210" data-t="21" style="left:354px;top:318px;display:block;position:absolute;font-size:40px;overflow:visible;">
                        <g fill="#fff7eb">
                            ...
                            <text filter="url(#jssor_1_flt_3)" x="0">
                                <textPath href="#jssor_1_pt_3" startoffset="100%" data-t="20">HYPER TEXT 
                                </textPath>
                            </text>
                        </g>
                    </svg>
                    <svg viewbox="0 0 360 210" data-to="50% 50%" width="360" height="210" data-t="23" style="left:354px;top:318px;display:block;position:absolute;font-size:32px;overflow:visible;">
                        <g fill="#fff7eb">
                            ...
                            <text filter="url(#jssor_1_flt_4)" x="0">
                                <textPath href="#jssor_1_pt_4" startoffset="100%" data-t="22">PREPROCESSOR
                                </textPath>
                            </text>
                        </g>
                    </svg>
            ...
            <div data-p="735">
                <img data-u="image" src="images/g5.jpg" />
                        ...
                        <svg viewbox="0 0 472 100" x="70" y="13" width="472" height="100" style="position:absolute;font-size:40px;overflow:visible;">
                            <g data-to="306px 63px" fill="#ffffff" data-t="24" style="opacity:0;letter-spacing:2em;">
                                ...
                                <text text-anchor="middle" x="236">
                                    <textPath href="#jssor_1_pt_5">JAVA
                                    </textPath>
                                </text>
                            </g>
                        </svg>
            ...
            <div data-p="735">
                <img data-u="image" src="images/g6.jpg" />
                <svg viewbox="0 0 590 280" data-ts="preserve-3d" width="590" height="280" data-tchd="jssor_1_msk_8" style="left:90px;top:17px;display:block;position:absolute;overflow:visible;">
                    <g mask="url(#jssor_1_msk_8)">
                        <svg viewbox="0 0 472 100" x="70" y="13" width="472" height="100" style="position:absolute;font-size:40px;overflow:visible;">
                            <g data-to="306px 63px" fill="#ffffff" data-t="24" style="opacity:0;letter-spacing:2em;">
                                <path id="jssor_1_pt_5" fill="none" d="M12,87L462,27"></path>
                                <text text-anchor="middle" x="236">
                                    <textPath href="#jssor_1_pt_5">PHP
                                    </textPath>
                                </text>
                            </g>
                        </svg>
            ...
            <div data-p="735">
                <img data-u="image" src="images/bg2.jpg" />
                <svg viewbox="0 0 590 280" data-ts="preserve-3d" width="590" height="280" data-tchd="jssor_1_msk_8" style="left:90px;top:17px;display:block;position:absolute;overflow:visible;">
                    <g mask="url(#jssor_1_msk_8)">
                        <svg viewbox="0 0 472 100" x="70" y="13" width="472" height="100" style="position:absolute;font-size:40px;overflow:visible;">
                            <g data-to="306px 63px" fill="#ffffff" data-t="24" style="opacity:0;letter-spacing:2em;">
